class CatalogueJeux{
    ...
    public void initGames(){
      this.addJeu(new Plateformer("Arcade", "logo.jpg","Jeu d'arcade où il faut éviter des objets", this.afficheur, this.mode));
      this.addJeu(new SampleGame("Sample Game 3D", "logo.jpg","Il s'agit d'un exemple d'un composant 3D dirigé par les flèches", this.afficheur, this.mode));
      this.addJeu(new TestJeu("Test1", "logo.jpg","Ce jeu est le template de base", this.afficheur, this.mode));
    }
